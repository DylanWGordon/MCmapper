...
INSERT INTO poi(name, biome, kind, x, y, z, comments) VALUES ('Random Beacon', 'Savanna', 'Player Settlement', 100, -271, 55, 'Got lost and created a random beacon.');

INSERT INTO poi(name, biome, kind, x, y, z, comments) VALUES ('Chest w/Loot!', 'Snowy Beach', 'Buried Treasure', 70, -17, 70, 'Found something, can''t dig it up yet. Coming back later.');

INSERT INTO poi(name, biome, kind, x, y, z, comments) VALUES ('Cave Entrance', 'Frozen River', 'Other', 90, 32, 86, 'There''s a cave leading into a chasm here. -Unexplored-.');

INSERT INTO poi(name, biome, kind, x, y, z, comments) VALUES ('Snowy Mountains! Great place for ice fishing.', 'Frozen Peaks', 'Other', 113, 86, 86, 'I want a giant ice castle up here.');

INSERT INTO poi(name, biome, kind, x, y, z, comments) VALUES ('Igloo!', 'Frozen River', 'Igloo', 87, -17, 70, 'Wanna'' make a base surrounding it. And then all of ''it'' belong to ''me''.');

INSERT INTO poi(name, biome, kind, x, y, z, comments) VALUES ('Half-Done Nether Gate', 'Frozen Peaks', 'Ruined Portal', 96, 75, 130, 'Need obsidian');

INSERT INTO poi(name, biome, kind, x, y, z, comments) VALUES ('Sudden Chasm', 'Dripstone Caves', 'Other', -10, 41, 170, 'The ground just stops, and it goes straight down.. I can see lava.');

INSERT INTO poi(name, biome, kind, x, y, z, comments) VALUES ('Treehouse!', 'Jungle', 'Player Settlement', 20, 20, -400, 'They just go up and up!');

INSERT INTO poi(name, biome, kind, x, y, z, comments) VALUES ('Spoopy Mayan Temple', 'Jungle', 'Jungle Temple', 50, -12, -430, 'Poison traps are common inside.');

INSERT INTO poi(name, biome, kind, x, y, z, comments) VALUES ('Death Spot', 'Jungle', 'Jungle Temple', 57, 15, -430, 'I died. Gotta'' go back and get my stuff, think it was around here. Look for the stairs.');